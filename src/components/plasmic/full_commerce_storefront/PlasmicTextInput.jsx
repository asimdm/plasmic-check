...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: yksKzv0YlLUoYS/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: HukJ_JXlKCnGeZ/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: dUYFriEhausTg5/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___2Mj3L)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uheU)}
                role={"img"}
              />
            ),
