...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: DR_CdaEAU-tYbd/component
import Select__Option from "../../Select__Option"; // plasmic-import: YvS6W_85AJ92pG/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: LszDXV334wwDS3/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: nCW-Vf4-l4BQgx/css
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: Bcg_Y5ikL43uZp/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: jFMfpdxYqWjoI-/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__sEfaK)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__f2Air)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
