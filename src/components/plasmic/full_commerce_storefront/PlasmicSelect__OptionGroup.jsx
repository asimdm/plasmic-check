...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: LszDXV334wwDS3/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: nCW-Vf4-l4BQgx/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__kdGhw)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__mxxU5)}
              />
            </React.Fragment>
          ),
