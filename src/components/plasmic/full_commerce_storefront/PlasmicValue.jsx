...
import sty from "./PlasmicValue.module.css"; // plasmic-import: zMLjntuNQvHvEv/css
import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: 4XmmIDaGhfdK_-/icon
...
function PlasmicValue__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___85BGi, {
          [sty.freeBoxcenter___85BGikWdNn]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom___85BGisQqVg]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__eb4VI)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__qEQwZ)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lz5Uz, {
          [sty.freeBoxcenter__lz5UzkWdNn]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__lz5Uz1Blms]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qkjgp, {
            [sty.freeBoxcenter__qkjgpkWdNn]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__qkjgp1Blms]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__egAp, {
                  [sty.buttonwithButton__egAp1Blms]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__gQqqh)}
                    role={"img"}
                  />
                }
                rounded={true}
